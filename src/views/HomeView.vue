...
const happyMessage = ref({
  reason: null
})

const validateFriend = () => {
  const friend = formData.value.reason
  const hasFriend = /\bfriend\b/i.test(friend)

  if (hasFriend) {
    happyMessage.value.reason = 'Great to have friend'
  } else {
    happyMessage.value.reason = null
  }
}
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-else-if="happyMessage.reason" class="text-success">
              {{ happyMessage.reason }}
            </div>
          </div>
          <div class="mb-3">
